...
#define TIMER_CLOCK_32       3
#define TIMER_CLOCK_64       4
#define TIMER_CLOCK_128      5
#define TIMER_CLOCK_256      6
#define TIMER_CLOCK_1024     7
...
#ifndef TIM2_OCI_ENABLE
#define TIM2_OCI_ENABLE 0
#endif

#ifndef TIM2_TOI_ENABLE
#define TIM2_TOI_ENABLE 0
#endif
...
/**
* Вернуть значение счетчика Timer2
*/
inline unsigned char timer2_value()
{
	return TCNT2;
}
...
*/
inline unsigned char timer2_get_compare()
{
	return OCR2;
}
...
*/
inline void timer2_set_compare(unsigned char value)
{
	OCR2 = value;
}
...
*/
inline void timer2_configure(char wgm, char com, char clock)
{
	TCCR2 = TIM2_TCCR(wgm, com, clock);
}
